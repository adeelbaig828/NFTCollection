    ...
    <div className='homePage'>
      <div className='subHeader'>
        <div
          className='bgImage'
          style={{
            background: `url(${browserWidth < 821 ? MOBILE_HEADER_IMG : BG_IMGAGE}) no-repeat`,
            width: '100%',
          }}
        >
          <div className='main_banner1 dispay_flex_c1 align_items_c1 justify_content_c1 main_page_width padding_add'>
            <div className='leftSide'>
              <span className='leftHeading'>Purchase artwork or start publishing now</span>
              <span className='leftSubHeading'>
                Explore a collection of entertaining animations, comics and anime of talented
            ...
            {browserWidth > 821 && (
              <div className='rightSide'>
                <span className='leftHeading'>
                  <NftCard showTopPick={true} data={topPick[0]} showFollowIcon={false} />
                </span>
              </div>
            )}
          </div>
